 ...
 *     Cursor c = builder.from(FeedContract.Entry.TABLE_NAME)       // String TABLE_NAME = "entry"
 ...
 * specified via method call. SQLBuilder takes care of issuing a "execute" command to the
...
public class SQLBuilder {
     ...
     *
     * <p>Calling this method is more efficient than creating a new SQLBuilder object.
     *
    ...
    /**
     * Table name to use for SQL {@code INTO} statement.
     *
     * <p>This method may only be called once. If multiple tables are required, concatenate them
     * in SQL-format (typically comma-separated).
     *
    ...
    public String toString() {
        return "SQLBuilder[table=" + mTable + ", selection=" + getSelection()
     ...
     */
    public Cursor execute(SQLiteDatabase db, String[] columns, String orderBy) {
        return execute(db, columns, null, null, orderBy, null);
    }
     ...
     *         {@link Cursor}s are not synchronized, see the documentation for more details.
     */
    public Cursor execute(SQLiteDatabase db, String[] columns, String groupBy,
                          String having, String orderBy, String limit) {
        assertTable();
        if (columns != null) mapColumns(columns);
        Log.v(TAG, "execute(columns=" + Arrays.toString(columns) + ") " + this);
